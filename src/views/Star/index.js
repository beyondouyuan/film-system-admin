/*
* @Author: beyondouyuan
* @Date:   2019-02-22 14:54:44
* @Last Modified by:   beyondouyuan
* @Last Modified time: 2019-02-22 21:52:59
...
import './index.less'
import { requestLikeList } from '../../api'
...
const columns = [{
    ...
    width: 150,
    align: 'center',
    render: (value, record) => value ? <img className="cover" src={value} alt={record.movieName} /> : '暂无数据'
  },{
    title: '电影评分',
    dataIndex: 'star',
    key: 'star',
